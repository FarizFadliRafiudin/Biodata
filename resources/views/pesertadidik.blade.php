              ...
              <div class="card-body">
                <form action="{{ route('pesertadidik.index') }}" method="get">
                  <div class="input-group">
                    <input type="search" name="search" class="form-control" placeholder="masukkan nama" value="{{ $vcari }}">
                ...
                @endif
                <a href="{{ route('pesertadidik.create') }}" class="btn btn-success">Tambah Data</a> - <a href="{{ url('pesertadidik/pdf') }}" class="btn btn-warning">Unduh PDF</a><br><br>
